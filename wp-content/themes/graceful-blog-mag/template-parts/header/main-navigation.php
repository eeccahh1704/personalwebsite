...
<style type="text/css">
	.current-menu-item a {
	    color: <?php echo esc_attr( graceful_blog_mag_options( 'main_navigation_active_link_color' ) ) ?> !important;
	}
	...
	.navigation-search-button {
	    background: <?php echo esc_attr( graceful_blog_mag_options( 'main_navigation_active_link_color' ) ) ?> !important;
	    border: 1px solid <?php echo esc_attr( graceful_blog_mag_options( 'main_navigation_active_link_color' ) ) ?> !important;
	}
</style>
